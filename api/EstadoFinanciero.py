# List of Lists
JSONCuentas=[{'id': 13, 'NombreCuenta': 'Capital social'},{'id': 12, 'NombreCuenta': 'Proveedores'},{'id': 11, 'NombreCuenta': 'Edificios'},{'id': 10, 'NombreCuenta': 'Terrenos'},{'id': 0, 'NombreCuenta': 'Almacen'}, {'id': 1, 'NombreCuenta': 'Ventas'}, {'id': 2, 'NombreCuenta': 'Costo de ventas'}, {'id': 0, 'NombreCuenta': 'Caja'}]
JSONMovIzq=[{'id': 11, 'NombreCuenta': 'Terrenos', 'NumMovimiento': '1', 'Cantidad': '20000', 'Check': True},{'id': 10, 'NombreCuenta': 'Edificios', 'NumMovimiento': '1', 'Cantidad': '20000', 'Check': True},{'id': 0, 'NombreCuenta': 'Almacen', 'NumMovimiento': '1', 'Cantidad': '20000', 'Check': True}, {'id': 1, 'NombreCuenta': 'Costo de ventas', 'NumMovimiento': '2', 'Cantidad': '1200', 'Check': True}, {'id': 2, 'NombreCuenta': 'Caja', 'NumMovimiento': '3', 'Cantidad': '50000', 'Check': True}]
JSONMovDer=[{'id': 12, 'NombreCuenta': 'Capital social', 'NumMovimiento': '1', 'Cantidad': '90000', 'Check': True},{'id': 10, 'NombreCuenta': 'Proveedores', 'NumMovimiento': '1', 'Cantidad': '90000', 'Check': True},{'id': 0, 'NombreCuenta': 'Ventas', 'NumMovimiento': '1', 'Cantidad': '200', 'Check': True}, {'id': 1, 'NombreCuenta': 'Almacen', 'NumMovimiento': '2', 'Cantidad': '1200', 'Check': True}, {'id': 2, 'NombreCuenta': 'Costo de ventas', 'NumMovimiento': '3', 'Cantidad': '50000', 'Check': True}]
UtilidadEjercicio = 10000
ImpuestosPagar = 1000
...
dataP.append(["Impuestos por pagar", ImpuestosPagar, ''.join(['$',str(PasivoCirculante-ImpuestosPagar)])])
Titulo = Bandera
TPFijo = 0
TPDiferido = 0
Bandera+=1
