# List of Lists
JSONCuentas=[{'id': 0, 'NombreCuenta': 'Almacen'}, {'id': 1, 'NombreCuenta': 'Ventas'}, {'id': 2, 'NombreCuenta': 'Costo de ventas'}, {'id': 0, 'NombreCuenta': 'Caja'}, {'id': 1, 'NombreCuenta': 'Gastos financieros'}, {'id': 2, 'NombreCuenta': 'Gasto de venta'}, {'id': 3, 'NombreCuenta': 'Gasto de administración'}, {'id': 4, 'NombreCuenta': 'Otros gastos'}]
JSONMovIzq=[{'id': 0, 'NombreCuenta': 'Almacen', 'NumMovimiento': '1', 'Cantidad': '366000', 'Check': True}, {'id': 1, 'NombreCuenta': 'Caja', 'NumMovimiento': '2', 'Cantidad': '115000', 'Check': True}, {'id': 2, 'NombreCuenta': 'Caja', 'NumMovimiento': '3', 'Cantidad': '230000', 'Check': True}, {'id': 3, 'NombreCuenta': 'Costo de ventas', 'NumMovimiento': '4', 'Cantidad': '115000', 'Check': True}, {'id': 4, 'NombreCuenta': 'Gastos financieros', 'NumMovimiento': '5', 'Cantidad': '4000', 'Check': True}, {'id': 5, 'NombreCuenta': 'Gasto de venta', 'NumMovimiento': '6', 'Cantidad': '83500', 'Check': True}, {'id': 6, 'NombreCuenta': 'Gasto de administración', 'NumMovimiento': '7', 'Cantidad': '78000', 'Check': True}, {'id': 7, 'NombreCuenta': 'Otros gastos', 'NumMovimiento': '8', 'Cantidad': '7000', 'Check': True}]
JSONMovDer=[{'id': 0, 'NombreCuenta': 'Caja', 'NumMovimiento': '1', 'Cantidad': '366000', 'Check': True}, {'id': 1, 'NombreCuenta': 'Almacen', 'NumMovimiento': '2', 'Cantidad': '115000', 'Check': True}, {'id': 2, 'NombreCuenta': 'Ventas', 'NumMovimiento': '3', 'Cantidad': '230000', 'Check': True}, {'id': 3, 'NombreCuenta': 'Caja', 'NumMovimiento': '4', 'Cantidad': '115000', 'Check': True}, {'id': 4, 'NombreCuenta': 'Caja', 'NumMovimiento': '5', 'Cantidad': '4000', 'Check': True}, {'id': 5, 'NombreCuenta': 'Caja', 'NumMovimiento': '6', 'Cantidad': '83500', 'Check': True}, {'id': 6, 'NombreCuenta': 'Caja', 'NumMovimiento': '7', 'Cantidad': '78000', 'Check': True}, {'id': 7, 'NombreCuenta': 'Caja', 'NumMovimiento': '8', 'Cantidad': '7000', 'Check': True}]
...
if(Tipo=='Analítico o Pormenorizado'):
    ...
    if(ArregloCuentasValores[6]-CantidadesOrdenadas[12]+CantidadesOrdenadas[13]>0):
        ...
        if(ArregloCuentasValores[7]-ArregloCuentasValores[7]*ISR-ArregloCuentasValores[7]*PTU>0):
            ...
            ArregloCuentasValores.append(ArregloCuentasValores[7]*ISR)
            ArregloCuentasValores.append(ArregloCuentasValores[7]*PTU)
            ArregloCuentasValores.append(ArregloCuentasValores[7]-ArregloCuentasValores[8]-ArregloCuentasValores[9])
        else:
...
for i in range(0,len(ArregloCuentas)):
    ...
    if ArregloCuentas[i]=="Perdida del ejercicio" or ArregloCuentas[i]=="Utilidad del ejercicio":
        if "ISR (36%)" in ArregloCuentas:
            ...
            dataP.append([ArregloCuentas[i-1]," ", " ",str(ArregloCuentasValores[i-1]),str(ArregloCuentasValores[i-1]+ArregloCuentasValores[i-2])])
            dataP.append([ArregloCuentas[i]," ", " "," ",str(ArregloCuentasValores[i])])
        else:
            dataP.append([ArregloCuentas[i]," ", " "," ",''.join(['(',str(ArregloCuentasValores[i]*-1),')'])])
